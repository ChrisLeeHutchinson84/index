...
function showCustomSlides(n) {
  ...
  captionText.innerHTML = dots[customSlideIndex - 1].alt;
...
fullscreenImages.forEach((fullscreenImage) => {
    const fullscreenImg = fullscreenImage.querySelector('.fullscreen-img');
...
clickableImages.forEach((image) => {
    image.addEventListener('click', () => {
        const fullscreenImage = image.closest('.card').querySelector('.fullscreen-image');
